...
%>
	<div id="wrap" class="container">
		<header class="d-flex align-items-center">
			<div class="col-2">
				<h3 class="text-success logo"><a href="/lesson02/quiz10.jsp">Melong</a></h3>
			</div>
			<div class="col-10">
		...
		<section class="contents">
			<div>
				<div class="artistInfo d-flex border border-success p-3">
					<img src="<%= artistInfo.get("photo") %>" alt="IuPhoto" width="150">
					<div class="ml-3">
				...
				<div class="artistSongs">
					...
					<table class="table text-center">
						...
						%>
							<tr>
								<td><%=music.get("id")%></td>
								<td><a href="/lesson02/quiz10_1.jsp?id=<%= music.get("id") %>"><%=music.get("title") %></a>
								</td>
