...
// 아이유 노래 리스트 
	...
	for (Map<String, Object> item : musicList) {
		if (id == (int)item.get("id") || item.get("title").equals(title)) {
			target = item;
			break;
		}
	}
    ...
    <div id="wrap" class="container">
		<header class="d-flex align-items-center">
			<div class="col-2">
				<h3 class="text-success"><a class="logo" href="/lesson02/quiz10.jsp">Melong</a></h3>
			</div>
			<div class="col-10">
		...
		<nav class="d-flex align-items-center">
			<ul class="nav nav-fill font-weight-bold">
                <li class="nav-item"><a class="nav-link" href="">멜롱차트</a></li>
		...
		<section class="contents">
			<div>
				<div><h2>곡 정보</h2></div>
				<div class="songInfo d-flex border border-success m-0 p-2">
					<%
					// for (Map<String, Object> song : musicList) {
						// if (song.get("title").equals(title) || (int)song.get("id") == id) {
						//	int minutes = ((int)song.get("time") / 60);
							// int extraSeconds = (int)song.get("time") % 60;
					%>
					<img src="<%= target.get("thumbnail") %>" alt="songAlbum" width="150">
					<div class="ml-3">
		...
		<footer class="d-flex align-items-center">
			<small class="info">Copyright © Melong 2024 All Rights Reserved</small>
		</footer>
	</div>
</body>
</html>