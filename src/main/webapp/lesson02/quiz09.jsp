	...
	<div id="wrap" class="container">
		...
		<nav class="bg-danger d-flex align-items-center">
			<ul class="nav nav-fill w-100">
                        ...
                        <li class="nav-item"><a class="nav-link" href="/lesson02/quiz09.jsp?category=예능">예능</a></li>
                        <li class="nav-item"><a class="nav-link" href="/lesson02/quiz09.jsp?category=스포츠">스포츠</a></li>
                    </ul>
		</nav>
		...
		<footer class="d-flex justify-content-center align-items-center">
			<small class="info">Copyright © SK Broadband IPTV 2024 All Rights Reserved</small>
		</footer>
	</div>
</body>
</html>